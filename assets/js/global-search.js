...
let allBlogPosts = [
    { title: 'Cloud Fundamentals for DevOps Beginners (2025): From Zero to Your First Free-Tier Server', url: 'cloud-fundamentals-for-devops.html', tags: ['DevOps', 'Cloud', 'AWS', 'Beginner'], excerpt: "A complete guide to cloud fundamentals for DevOps beginners in 2025. Learn AWS EC2 basics, set up a free-tier account, and launch your first cloud server.", image: 'assets/images/blog/cloud_fundamentals_cover.webp' },
    { title: 'Docker Tutorial for DevOps Beginners (2025): Build a Tiny App and Containerize It from Scratch', url: 'docker-tutorial-for-beginners.html', tags: ['DevOps', 'Docker', 'Containers', 'Tutorial'], excerpt: "A complete Docker tutorial for DevOps beginners in 2025. Learn to build a tiny Node.js or Python app and containerize it from scratch. Resume-ready project included.", image: 'assets/images/blog/docker_tutorial_cover.webp' },
    { title: '10 Beginner DevOps Projects You Can Build in 2025 (GitHub Actions, Docker, Terraform & More)', url: 'devops-projects-for-beginners.html', tags: ['DevOps', 'Projects', 'GitHub Actions', 'Docker', 'Terraform'], excerpt: "Looking for DevOps project ideas for beginners? Here are 10 hands-on DevOps projects using GitHub Actions, Docker, and Terraform to build your resume in 2025.", image: 'assets/images/blog/devops_roadmap_cover.webp' },
